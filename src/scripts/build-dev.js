...
const buildDirectory = resolve(projectRoot, 'src/test/js');
const buildBundleFile = resolve(projectRoot, 'src/test/js/masonry.js');

/**
 * Builds the bundle by reading source files, combining them, and writing to the test directory.
 *
